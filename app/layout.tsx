...
export const metadata: Metadata = {
  ...
  authors: [{ name: "مؤسسة تبارك الذكية", url: "https://tabaraktechpay.com" }],
  ...
  openGraph: {
    ...
    images: [{ url: "https://tabaraktechpay.com/android-chrome-512x512.png", width: 512, height: 512, alt: "تبارك الذكية" }],
  },
  twitter: {
    card: "summary",
    title: "تبارك الذكية | منصة التحقق المالي الذكي",
